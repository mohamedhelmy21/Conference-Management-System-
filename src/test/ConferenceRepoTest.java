...
public class ConferenceRepoTest {
    public static void main(String[] args) {
        try {
            ...
            Conference foundConference = conferenceRepository.findById(101);
            ...
            conferenceRepository.save(conference1);
            System.out.println("Updated Conference: " + conferenceRepository.findById(101));
            ...
            System.out.println("\n=== Test 6: Delete a Conference ===");
            conferenceRepository.delete(102);
